...
import fr.insa.soa.RestProject.Binome;
...
public class EtudiantRessource {
	...
	public Etudiant getEtudiant(@Context UriInfo uriInfo) { // UriInfo est utilisé pour acceder aux informations des requetes
	...
	private String getUriforStage(UriInfo uriInfo) {
		String url=uriInfo.getBaseUriBuilder()  //http://localhost:8080/RestProtect/webapi
